...
const Navbar = () => {
  return (
    <nav className="fixed top-0 left-0 right-0 bg-amber-100/90 backdrop-blur-sm shadow-md z-50">
        <div className="container mx-auto px-6 py-6 flex justify-between items-center">
          <div className="flex items-center">
            <Home className="text-amber-600 mr-4" size={30} />
            <h1 className="text-2xl font-bold text-amber-900">StudentSphere</h1>
          </div>
